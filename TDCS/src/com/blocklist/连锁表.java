...
public class 连锁表 {
	public final long time=10;			//列车的行驶速度时间
	public 调车信号机 d1;
	...
	public String zhengxianjiecheX_S2() throws InterruptedException{   //正线接车操作，不涉及画图
	...
	public String diaoched1_S2() throws InterruptedException{   //d1至s2调车操作，不涉及画图
	...
	public String facheches1_x() throws InterruptedException{   //侧线发车操作，不涉及画图
	...
	public String diaoches1_d1() throws InterruptedException{   //s1至d1调车操作，不涉及画图
		int a1=dc3.getblock()+dg3.getblock();  //锁闭条件
		int a2=dg3.getclean();  //空闲条件
		System.out.println(a1+" "+a2);
		if(a1==0&&a2==1){
	...
	public String facheches2_x() throws InterruptedException{   //正线发车操作，不涉及画图
		int a1=adg.getblock()+dc3.getblock()+xdg.getblock()+dg3.getblock();  //锁闭条件
		int a2=adg.getclean()+dg3.getclean()+xdg.getclean();  //空闲条件
		System.out.println(a1+" "+a2);
		if(a1==0&&a2==3){
	...
	public String diaoches2_d1() throws InterruptedException{   //s2至d1调车操作，不涉及画图
		int a1=dc3.getblock()+dg3.getblock();  //锁闭条件
		int a2=dg3.getclean();  //空闲条件
		System.out.println(a1+" "+a2);
		if(a1==0&&a2==1){
	...
	public String cexianjiecheX_S1() throws InterruptedException{   //侧线接车操作，不涉及画图
	...
	public String diaoched1_S1() throws InterruptedException{   //d1至s1调车操作，不涉及画图
		int a1=dc3.getblock()+dg3.getblock();  //锁闭条件
		int a2=dg3.getclean();  //空闲条件
		System.out.println(a1+" "+a2);
		if(a1==0&&a2==1){
